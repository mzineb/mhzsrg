...
<link href="<?php echo HTTP_CATALOG; ?>catalog/view/theme/<?php echo $themeName;?>/stylesheet/bootstrap.css" rel="stylesheet" />
<link href="<?php echo HTTP_SERVER; ?>view/stylesheet/customizetheme.css" rel="stylesheet" />

<link rel="stylesheet" type="text/css" href="<?php echo HTTP_CATALOG; ?>catalog/view/theme/<?php echo $themeName;?>/stylesheet/font-awesome.min.css" />
<link rel="stylesheet" type="text/css" href="<?php echo HTTP_CATALOG; ?>catalog/view/javascript/jquery/colorpicker/css/colorpicker.css" />

<script type="text/javascript" src="<?php echo HTTP_CATALOG; ?>catalog/view/javascript/jquery/jquery-1.7.1.min.js"></script>
 	
<script type="text/javascript" src="<?php echo HTTP_CATALOG; ?>catalog/view/javascript/jquery/bootstrap/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo HTTP_CATALOG; ?>catalog/view/javascript/jquery/colorpicker/js/colorpicker.js"></script>
<script type="text/javascript" src="<?php echo HTTP_CATALOG; ?>view/javascript/themecontrol/pekeUpload.js"></script>
