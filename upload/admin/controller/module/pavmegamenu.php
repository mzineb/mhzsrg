...
class ControllerModulePavmegamenu extends Controller {
	...
	public function index() {   
		...
		$this->data['liveedit_url'] = $this->url->link('module/pavmegamenu/liveedit', 'root=1&token=' . $this->session->data['token'], 'SSL');
	...
	public function liveedit(){
		...
		$this->data['liveedit_action'] = $this->url->link('module/pavmegamenu/livesave', 'root=1&token=' . $this->session->data['token'], 'SSL');
		$this->data['action_backlink'] = $this->url->link('module/pavmegamenu', 'root=1&token=' . $this->session->data['token'], 'SSL');
		$this->data['action_widget'] =  HTTPS_CATALOG.'index.php?route=module/pavmegamenu/renderwidget';
		$this->data['action_addwidget'] = $this->url->link('module/pavmegamenu/addwidget', 'token=' . $this->session->data['token'], 'SSL'); 


		$this->data['ajxgenmenu'] 	   = $this->url->link('module/pavmegamenu/ajxgenmenu', 'root=1&token=' . $this->session->data['token'], 'SSL'); 
		$this->data['ajxmenuinfo'] 	   = $this->url->link('module/pavmegamenu/ajxmenuinfo', 'root=1&token=' . $this->session->data['token'], 'SSL'); 
	...
	public function ajxgenmenu( ){ 
		...
		if( isset($this->request->post['reset']) ){
	 	...
	 	$this->data['treemenu'] = $this->model_menu_tree->getTree( 1, true, $params );
