...
class ControllerModuleThemeControl extends Controller {
	...
	public function customize(){
		...
		$themeConfig = $this->config->get( 'themecontrol' ); 
	 	...
	 	$this->data['customizeFolderURL'] = HTTP_CATALOG.'catalog/view/theme/'.$theme.'/stylesheet/customize/';
	 	$this->data['backgroundImageURL'] = HTTP_CATALOG.'catalog/view/theme/'.$theme.'/image/pattern/';
	 	$this->data['token'] = $this->session->data['token'];
	 	$this->data['patterns'] = $this->getPattern();
